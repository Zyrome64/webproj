...
def drive():
    if request.method == 'GET':
        ...
        print(f.filename)
        if f.filename:
            if request.form['foldername'].replace(' ', '_') != '' and not os.path.isdir(os.path.dirname(os.path.abspath(__file__)) + '\\static\\' + session['username'] + '\\files\\' + request.form['foldername'].replace(' ', '_')):
                os.mkdir(os.path.dirname(os.path.abspath(__file__)) + '\\static\\' + session['username'] + '\\files\\' + request.form['foldername'].replace(' ', '_'))
            f.save(os.path.dirname(os.path.abspath(__file__)) + '\\static\\' + session['username'] + '\\files\\' + request.form['foldername'] + '\\' + f.filename.replace(' ', '_'))
